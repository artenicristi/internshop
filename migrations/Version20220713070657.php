 ...
 */
final class Version20220713070657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE image_url image_url VARCHAR(255) DEFAULT NULL, CHANGE category_id_id category_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE image_url image_url VARCHAR(255) NOT NULL, CHANGE category_id category_id_id INT NOT NULL');
